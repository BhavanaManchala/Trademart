...
import Trademart_Utilities.Trademart_SellerLoginReadConfig;

public class Trademart_SellerBase 
{
	public static WebDriver driver;
	public static Logger log;
	Trademart_SellerLoginReadConfig rc= new Trademart_SellerLoginReadConfig();
